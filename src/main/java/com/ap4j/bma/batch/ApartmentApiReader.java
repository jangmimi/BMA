...
public class ApartmentApiReader implements ItemReader<List<AptBatchDTO>> {
	...
	@Override
	public List<AptBatchDTO> read() throws Exception, UnexpectedInputException, ParseException, NonTransientResourceException {
		if (!read) {
